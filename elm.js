...
Elm.SearchExample.make = function (_elm) {
   "use strict";
   _elm.SearchExample = _elm.SearchExample || {};
   if (_elm.SearchExample.values) return _elm.SearchExample.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var model = {inList: _U.list(["Test","More Tests"]),output: _U.list([])};
   ...
   var update = F2(function (action,model) {
      ...
      if (_p1.ctor === "NoOp") {
            ...
            return _U.update(model,{output: A2(query,model.inList,_p1._0)});
         }
   });
   ...
   var main = $StartApp$Simple.start({update: update,view: view,model: model});
   var NoOp = {ctor: "NoOp"};
   var Model = F2(function (a,b) {    return {output: a,inList: b};});
   return _elm.SearchExample.values = {_op: _op,Model: Model,NoOp: NoOp,NewQuery: NewQuery,query: query,update: update,view: view,model: model,main: main};
};
